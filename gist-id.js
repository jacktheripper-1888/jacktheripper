...
<production/Statue>
        ...
        edm:provider "Tate, London";
        ead:href "https://www.tate.org.uk/";
        gn:name "London,England";
        ead:date "1976";
        edm:isrelatedto "Jack the Ripper";
        crm:P15_was_influenced_by "Whitechapel Murders";
        rdfs:seeAlso "Jack the Ripper (painting)";
        rdf:type "Painting";
        dc:medium "Paper";
        dc:creator "Montelius Olle";
        foaf:isPrimaryTopicOf "http://worldcat.org/identities/lccn-n85219099/";
